...
export default function App() {
    return (
        <View className="flex-1 items-center justify-center bg-white">
            ...
            <Link href="/getCode" className="mt-[20px] text-blue-500"> GetCode</Link>
            <Link href="/typePin" className="mt-[20px] text-blue-500">TypePin</Link>
            <Link href="/profile" className="mt-[20px] text-blue-500">Profile</Link>
            <Link href="/find" className='mt-[20px]'>Find Location</Link>
