...
export default function PickUp({ setPickBook }) {
    ...
    return (
        <View className="absolute bottom-0 w-full px-[15px] flex flex-col justify-center items-center bg-white pt-[20px]">
            ...
            <Pressable onPress={() => setPickBook(prev => !prev)} className="bg-[#00B14F] min-w-[350px] py-[15px] rounded-[8px] flex justify-center items-center mb-[15px]">
